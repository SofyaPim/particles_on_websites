...
window.addEventListener("DOMContentLoaded", function () {
  ...
  gradient.addColorStop(0, "#374471");
  gradient.addColorStop(0.5, "#b8edff");
  gradient.addColorStop(1, "#3d85a9");
  ...
  class Particle {
    ...
    update() {
      ...
      if (
        ...
        this.y - this.radius + this.height > this.effect.heading.y &&
        this.bounced < 10
      ) {
        // Collision detected!
        this.vy *= -0.6;
  ...
  class Effect {
    ...
    resize(width, height) {
      ...
      // this.context.strokeStyle = gradient; //lines like particles
